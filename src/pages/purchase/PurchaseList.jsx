          ...
          <table className="w-full m-5">
            ...
            <tbody>
              ...
              >
                ...
                <td className="border pl-5">INV-90809809</td>
                <td className="border pl-5">Kertas A4</td>
                <td className="border pl-5">200</td>
                <td className="border pl-5">rim</td>
                <td className="border pl-5">8000000</td>
                <td className="border pl-5">Yes</td>
                <td className="border flex justify-center h-16 space-x-2">
                  <Link
                    to={`/admin/purchase/edit?id=1`}
                    className="w-6 h6"
                  >
